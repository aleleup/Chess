...
public class BoardTests {
    ...
    //     System.out.println(board.toString());
    //     int[] queenMove = {7,0};
    //     assertTrue(board.move(p_f, queenMove));
    //     System.out.println(board.toString());

    //     board = new Board();

    //     board.setBoardFromKey(key1);
    //     assertTrue(board.moveAndUpgradePawn(p_0, p_f, "R"));
    //     System.out.println(board.toString());
    //     int[] rookMove = {0,0};
    //     assertTrue(board.move(p_f, rookMove));
    //     System.out.println(board.toString());
    ...
    //     System.out.println(board.toString());
    //     int[] boshopMove = {4,3};
    //     assertTrue(board.move(p_f, boshopMove));
    //     System.out.println(board.toString());
    ...
    //     System.out.println(board.toString());
    //     int[] knightMove = {1,5};
    //     assertTrue(board.move(p_f, knightMove));
    //     System.out.println(board.toString());
